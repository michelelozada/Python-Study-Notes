...
'''
1 - Considere um sistema que forneça acesso somente se o login (LuisRamos) e a senha(Prisma84*) forem informados corretamente.
...
'''
2 - Existia uma brincadeira que consistia em contar os números em voz alta, substituindo os números múltiplos de 4 pela 
